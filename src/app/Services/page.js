                        ...
                        <div className={styles.BoxContainer}>
                                ...
                                />
                                 <div className={styles.overlay}>
                                    <div className={styles.text}>
                                        ...
                                        <p className={styles.textSecret}> Host your special moments with us! From birthdays to corporate gatherings.
                                             </p>
                                    </div>
                                </div>
                              </div>
                             ...
                             <img
                                ...
                                />
                                 <div className={styles.overlay}>
                                    <div className={styles.text}>
                                        ...
                                        <p className={styles.textSecret}>Make your corporate events unforgettable with our exceptional catering and ambiance.</p>
                                    </div>
                                </div>
                              </div>
                                ...
                                />
                                  <div className={styles.overlay}>
                                    <div className={styles.text}>
                                        <div><h3 className={styles.textDesp}>  Weddings</h3></div>
                                        <p className={styles.textSecret}> Make your special day unforgettable with our exquisite wedding catering. From personalized menus to flawless service.</p>
                                    </div>
                                </div>
                                </div>
                                ...
                                />
                                  <div className={styles.overlay}>
                                    <div className={styles.text}>
                                        ...
                                        <p className={styles.textSecret}> We are also available on Zomato and Swiggy. You can place your order there.</p>
                                    </div>
                                </div>
                                </div>
