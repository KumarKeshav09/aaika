        ...
        <>
            ...
            <div className="">
                ...
                >
                    ...
                    />
                    <blockquote
                        className="max-w-2xl mx-auto text-[#3e3930] dark:text-white text-6xl font-normal italic"
                    >
                        Savor the flavor, where every bite delights.
                    </blockquote>

                    <figcaption
                        className="mt-4 text-lg font-normal  dark:text-gray-300"
                    >
                        - Aiika
                    </figcaption>
                </div>
            ...
            <div className="max-w-7xl mx-auto py-10 px-5 lg:px-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="overflow-hidden shadow-lg">
                        <img src="https://images.pexels.com/photos/13033658/pexels-photo-13033658.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Social Event" className="w-full h-auto object-cover" />
                    </div>


                    <div>
                        <p className="uppercase tracking-widest">catering</p>
                        <h2 className="text-5xl text-[#3e3930]  italic font-normal mb-4">Social events</h2>
                        <p className="mb-6">
                        Host your special moments with us! From birthdays to corporate gatherings,
                         we offer the perfect setting with customized menus to suit every occasion. 
                         Let us make your event memorable with delightful food and exceptional service.
                        </p>
            ...
            <div className="max-w-7xl mx-auto py-10 px-2 lg:px-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        <p className="uppercase tracking-widest">catering</p>
                        <h2 className="text-5xl text-[#3e3930]  italic font-normal mb-4">Corporate parties</h2>
                        <p className="text-gray-500 mb-6">
                        Make your corporate events unforgettable with our exceptional catering and ambiance. We offer tailored menus to suit every occasion, ensuring a perfect blend of flavors. 
                        Elevate your office parties with a unique dining experience that impresses your team and clients alike.
                        </p>
                        <p className="text-grey-500">Read More</p>

                    </div>
                    <div className="overflow-hidden  shadow-lg">
                        <img src="https://images.pexels.com/photos/8818723/pexels-photo-8818723.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Social Event" className="w-full h-auto object-cover" />
                    </div>
                </div>
            </div>
            <div className="max-w-7xl mx-auto py-10 px-5 lg:px-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="overflow-hidden  shadow-lg">
                        <img src="https://images.pexels.com/photos/11479023/pexels-photo-11479023.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Social Event" className="w-full h-auto object-cover" />
                    </div>


                    <div>
                        <p className="uppercase tracking-widest">catering</p>
                        <h2 className="text-5xl text-[#3e3930]  italic font-normal mb-4">Weddings</h2>
                        <p className="text-gray-500 mb-6">
                        Make your special day unforgettable with our exquisite wedding catering. From personalized menus to flawless service, we ensure every detail is perfect. 
                        Celebrate love with a feast that leaves lasting memories
                        </p>
                        <p className="text-grey-500">Read More</p>
            ...
            <div className="slider-container max-w-7xl mx-auto py-10 px-2 lg:px-10">
                <Slider {...tetimonialSettings}>
                    ...
                    {/* <div className="item">
                        <div class="bg-yellow-400 max-w-lg w-full  shadow-lg p-6 relative overflow-hidden">

                            <div class="absolute -left-8 top-0 bg-red-500 w-1/3 h-full  flex flex-col items-center justify-center py-6">

                                <div class="bg-white rounded-full p-2 mb-4">
                                    <img src="https://rezista.in/wp-content/uploads/2020/07/testimonial-avatar-female-1-ux-builder.jpg" alt="Profile" class="w-20 h-20 object-cover rounded-full" />
                                </div>

                                <p class="text-white text-center text-sm font-bold">Dharmendra <br /> Neelu Jain</p>
                            </div>


                            <div class="ml-32">

                                <h2 class="text-black font-bold text-xl">Hi Ashish</h2>
            ...
            <div className="max-w-7xl mx-auto py-16 px-5 lg:px-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-5xl text-[#3e3930]  italic font-normal mb-4">Kitchen True Master
                        </h2>

                        <p className="text-gray-500 mb-6">
                        At the heart of every dish is our masterful kitchen. With precision, passion, and expertise, our chefs craft meals that celebrate authenticity. Every recipe is a blend of tradition and innovation, perfected over time.
                         Trust the true masters to serve you flavors that linger long after the last bite.
                        </p>
                    ...
                    <div className="overflow-hidden">
                        <img src="https://banquet.qodeinteractive.com/wp-content/uploads/2019/11/h1-img-6.jpg" alt="Event Master" className=" shadow-lg max-w-[448px] max-h-[610px] object-cover" />
                    </div>
                </div>
            </div>
            <div className="max-w-7xl mx-auto py-16 px-5 lg:px-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="hover-container overflow-hidden">
                        <img src="https://images.pexels.com/photos/17223836/pexels-photo-17223836/free-photo-of-food-on-plate.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Image 1" className="hover-image" />
                    ...
                    <div className="hover-container overflow-hidden">
                        <img src="https://images.pexels.com/photos/1051399/pexels-photo-1051399.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Image 2" className="hover-image" />
                        <div className="hover-bg"></div>
                        <div className="hover-text">
                            <p className="uppercase tracking-widest">Party</p>
                            <p className="italic font-normal text-2xl">Taste like home food </p>
