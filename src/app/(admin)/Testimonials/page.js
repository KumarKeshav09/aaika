  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(
        `${API_BASE_URL}/testimonial/getAllTestimonials?page=${page}&limit=10`
      );
  ...
  return (
    <section className="md:p-5">
      <div className="relative overflow-x-auto sm:rounded-lg">
        <h1 className="text-2xl text-black underline mb-3 font-bold">Testimonial</h1>
      ...
      <Pagination data={listData} pageNo={handlePageChange} pageVal={page} totalCount={listData?.totalTestimonials} />
      <Popup
        isOpen={isPopupOpen}
